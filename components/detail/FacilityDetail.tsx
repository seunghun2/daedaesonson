...
interface FacilityDetailProps {
    ...
    isDetailLoading?: boolean; // API 로딩 중 (스켈레톤 표시)
}

export default function FacilityDetail({ facility: initialFacility, onClose, allFacilities = [], onSelectFacility, onMapView, initialConsultOpen = false, isDesktop = false, isDetailLoading = false }: FacilityDetailProps) {
