...
## 시설 추천 형식
시설 추천 시:
- 시설 링크는 반드시 아래 데이터에 표시된 "ID:" 값을 그대로 사용합니다.
- 예: ID가 "park-0002"이면 → [시설명 >](https://daedaesonson.com/facility/park-0002)
- 절대로 ID를 임의 숫자(123, 456 등)로 만들지 마세요! 404 에러가 발생합니다.
- **[시설명 >](https://daedaesonson.com/facility/실제ID)**, 봉안당/수목장/화장시설, 지역
