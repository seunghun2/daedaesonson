...
import {
    ...
    MessageSquare, TrendingUp, TrendingDown, List
} from 'lucide-react';
                    ...
                    <Tabs.Panel value="price" pt="md">
                        {(editForm as any)._detailedSource === 'prisma' ? (
                            ...
                            <Box>
                                ...
                                <Accordion variant="separated" multiple defaultValue={Object.keys(editForm.priceInfo?.priceTable || {})}>
                                    {Object.entries(editForm.priceInfo?.priceTable || {})
                                        .filter(([catName]) => {
                                            let group = '기타';
                                            if (/매장|묘지|석물|작업|봉분|둘레석/.test(catName)) group = '매장묘';
                                            else if (/기본비용/.test(catName)) group = '매장묘'; // Group logic
