/**
 * park-0580 용미리건물식추모의집 — 봉안당(관내) / 봉안당(관외) 아코디언 분리
 */
...
async function fix() {
    ...
    const p = data.find(x => x.id === 'park-0580');
    ...
    p.priceInfo.priceTable = {
        '봉안당(관내)': {
            ...
            rows: [
                { name: '재사용료 (일반)', price: 100000, isRepresentative: true, grade: '5년 연장' },
                { name: '재사용료 (유공자)', price: 50000, grade: '5년 연장' },
                { name: '재사용료 (수급자)', price: 50000, grade: '5년 연장' },
            ]
        },
        '봉안당(관외)': {
            category: 'charnel', unit: '원',
            rows: [
                { name: '재사용료 (일반)', price: 300000, isRepresentative: true, grade: '5년 연장' },
                { name: '재사용료 (유공자)', price: 150000, grade: '5년 연장' },
                { name: '재사용료 (수급자)', price: 120000, grade: '5년 연장' },
            ]
        }
    };
            ...
            rows: [
                {
                    ...
                    grade: '5년 기간연장', note: '신규사용 불가. 부부단 동일요금', residency: 'LOCAL'
                },
                {
            ...
            rows: [
                {
                    ...
                    grade: '5년 기간연장', note: '신규사용 불가. 부부단 동일요금', residency: 'NON_LOCAL'
                },
                {
    ...
    console.log('✅ park-0580 → 봉안당(관내) / 봉안당(관외) 아코디언 분리 완료');
