/**
 * park-0584 서울시립승화원 추모의집 — 공설 봉안당
 * 580과 동일 패턴: 봉안당(관내)/봉안당(관외) 아코디언 분리
 * EXTENSION→USAGE, RESIDENT→LOCAL, 신규불가 0원 제거
 */
...
async function fix() {
    ...
    const p = data.find(x => x.id === 'park-0584');
            ...
            rows: [
                {
                    ...
                    grade: '5년 기간연장', residency: 'LOCAL', note: '신규사용 불가. 부부단 동일요금'
                },
                {
            ...
            rows: [
                {
                    ...
                    grade: '5년 기간연장', residency: 'NON_LOCAL', note: '신규사용 불가. 부부단 동일요금'
                },
                {
    ...
    console.log('✅ park-0584 서울시립승화원 추모의집 → 관내/관외 분리, 공설 정제 완료');
