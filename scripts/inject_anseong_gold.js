...
console.log("💎 Injecting Gold Standard Data for Anseong Catholic (천주교안성추모공원)...");
...
const perfectPricing = {
    '매장묘': {
        rows: [
            // Only valid high-cost items
            {
                name: "매장(단장) 봉분 설치비",
                price: 89000000,
                description: "천주교 전용 (사용료/관리비/석물 미포함)",
                isRepresentative: true // 8,900만원부터
            },
            {
                name: "매장(합장) 봉분 설치비",
                price: 178000000,
    ...
    '봉안당': {
        rows: [
            // No usage fee data available. Only stones.
            {
                name: "봉안당 안치 사용료",
                price: 0,
                description: "가격 정보 없음 (별도 문의)",
                isRepresentative: true // "문의" 처리
            }
        ]
    },
    '수목장': {
    ...
    '옵션': { // All stone and accessories (Expensive)
        rows: [
...
console.log("✅ Anseong Catholic (천주교안성추모공원) Data has been reset to the Gold Standard.");
